...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function (type) {
	  ...
	  this.playerOneTank = new Tank([100, Game.DIM_Y - 105], 5, 35, 0, this, "Player One");
	  this.playerTwoTank = new Tank([875, Game.DIM_Y - 110], 175, 35, 0, this, "Player Two");
	  this.missiles = [];
	  this.isWon = false;
	  this.winner = "";
	  this.paras = [];
